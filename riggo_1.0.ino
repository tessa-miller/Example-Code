...
#define TRIGGER_PINL  A4  // Arduino pin tied to trigger pin on ping sensor.
#define ECHO_PINL     A5  // Arduino pin tied to echo pin on ping sensor.

#define MAX_DISTANCE 100 // Maximum distance we want to ping for (in centimeters). Maximum sensor distance is rated at 400-500cm.

#define TRIGGER_PINF  A1  // Arduino pin tied to trigger pin on ping sensor.
#define ECHO_PINF     A0  // Arduino pin tied to echo pin on ping sensor.
